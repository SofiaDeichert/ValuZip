...
import ZIP_CITIES from '../data/zip_cities.js';
...
export default function PropertyForm({ selectedZip, setSelectedZip }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!(Number(formData.zip) in ZIP_CITIES)) {
      setSubmitError(
        'That ZIP code is not in our Dallas coverage area. Please enter a valid Dallas-area ZIP.',
      );
      return;
    }
