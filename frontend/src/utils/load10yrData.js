import datasetUrl from '../data/final_10yrs.csv?url';

// Long-term trend dataset (10 years). This loader is intentionally isolated and
// is not connected to current UI flows yet.
...
export function load10yrData() {
  if (parsed10yrDataPromise) return parsed10yrDataPromise;

  parsed10yrDataPromise = Promise.resolve().then(async () => {
  ...
  return parsed10yrDataPromise;
}

export default load10yrData;
