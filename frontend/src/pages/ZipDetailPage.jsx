...
export default function ZipDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* ── Nav row: back button (left) + ZIP search (right) ── */}
      <div
      ...
      >
        {/* Back button — standalone, untouched */}
        <button
          onClick={() => navigate('/')}
        ...
        {/* ZIP search — separate component */}
        <ZipSelect currentZip={zip} style={{ width: 220 }} />
      </div>

      {/* Map */}
      <div
        className="mx-6 rounded-2xl overflow-hidden shadow-md"
        style={{ height: '340px' }}
      >
        {viewState && (
          <Map
